(function (node) {
    ...
    var ilkTokens = Token.create();

    var prepare = function (constructor) {
        ilkTokens.mark(constructor, {
            shared: {},
            hidden: {}
        });
        ...
        constructor.shared = function (shared) {
            constructor[ilkTokens].shared = shared;
            return constructor;
        };

        /**
         * Stores the hidden tokens within the constructor's closure. These
         * tokens may be accessed through the expose API in order to access
         * hidden tokens for testing purposes.
         *
         * @method hidden
         * @foor ilk.Ilk
         *
         ...
         * @return {ilk.Ilk}
         */
        constructor.hidden = function (hidden) {
            merge(constructor[ilkTokens].hidden, hidden);
            return constructor;
        };
        ...
        constructor.descend = overload(
            ...
            function (descendant, shared) {
                ...
                if (shared) {
                    merge(shared, constructor[ilkTokens].shared);
                }

                return inherits(descendant, constructor).
                    shared(constructor[ilkTokens].shared);
            });
    ...
    ilk.expose = function (constructor) {
        var tokens = {};
        parts.forEach(constructor[ilkTokens], function (t, n) {
            tokens[n] = {};
            merge(tokens[n], t);
        });
        return tokens;
